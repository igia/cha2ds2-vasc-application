...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("cha2ds2vascapp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("cha2ds2vascapp");
        ...
        config.getMapConfigs().put("io.igia.cha2ds2vasc.app.domain.*", initializeDomainMapConfig(jHipsterProperties));
